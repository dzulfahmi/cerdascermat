...
class PTimer extends React.Component {
  state = {
    point1: 0,
    point2: 0,
    point3: 0,
  ...
  render() {
    ...
    <>
      <Container className="bg-secondary" fluid>
        <Row className="my-2">
          <Col xl="3" lg="3" sm="3" className="my-3">
            <Card body>
              ...
              <CardText><p className="text-center display-1">{this.state.point1}</p></CardText>
            </Card>
          </Col>
          <Col xl="3" lg="3" sm="3" className="my-3">
            <Card body>
              <CardTitle><p className="text-center h2">UMAR</p></CardTitle>
              <CardText><p className="text-center display-1">{this.state.point2}</p></CardText>
            </Card>
          </Col>
          <Col xl="3" lg="3" sm="3" className="my-3">
            <Card body>
              <CardTitle><p className="text-center h2">USMAN</p></CardTitle>
              <CardText><p className="text-center display-1">{this.state.point3}</p></CardText>
            </Card>
          </Col>
          <Col xl="3" lg="3" sm="3" className="my-3">
            <Card body>
              <CardTitle><p className="text-center h2">ALI</p></CardTitle>
              <CardText><p className="text-center display-1">{this.state.point4}</p></CardText>
            </Card>
          </Col>
        </Row>  
        <Row>
        ...
        <Row className="my-3">
          <Col sm={12} xl={12} lg={12} className="text-center">
            <Timer />
          </Col>
        </Row>
      </Container></>
